...
# Supported language codes: en-US, de-DE, es-US, ru-RU
...
riva_ngc_org="nvidia"
riva_ngc_team="riva"
riva_ngc_image_version="1.10.0-beta"
riva_ngc_model_version="1.10.0-beta"
...
### Conformer acoustic model, CPU decoder, best latency configuration
...
if [[ $riva_target_arch == "arm64" ]]; then
  ...
  ### Citrinet-256 Streaming w/ CPU decoder
      "${riva_ngc_org}/${riva_ngc_team}/asr_models_aarch64:${riva_ngc_model_version}"
  #    "${riva_ngc_org}/${riva_ngc_team}/asr_custom_rmir_name:${riva_ngc_model_version}"
  )

  models_nlp=(
  ### DistilBERT based misty domain (weather, smalltalk/personality, poi/map)
      "${riva_ngc_org}/${riva_ngc_team}/nlp_misty_models_aarch64:${riva_ngc_model_version}"
  #    "${riva_ngc_org}/${riva_ngc_team}/nlp_custom_rmir_name:${riva_ngc_model_version}"
  )

  models_tts=(
  ### Fastpitch + HiFiGAN model
      "${riva_ngc_org}/${riva_ngc_team}/tts_models_aarch64:${riva_ngc_model_version}"
  #    "${riva_ngc_org}/${riva_ngc_team}/tts_custom_rmir_name:${riva_ngc_model_version}"
  )
fi
